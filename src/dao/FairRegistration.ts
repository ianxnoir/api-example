...
import { FairRegistrationDynamicBm } from "./FairRegistrationDynamicBm";
import { FairRegistrationCustomQuestion } from "./FairRegistrationCustomQuestion";
import { FairRegistrationTicketPass } from "./FairRegistrationTicketPass";
import { FairRegistrationDynamicOthers } from "./FairRegistrationDynamicOthers";
...
@Entity("fairRegistration", { schema: "vepFairDb" })
export class FairRegistration extends VepItem {
  ...
  @Column("varchar", { name: "addressCountryCode", nullable: true, length: 20 })
  ...
  @Column("varchar", { name: "correspondenceEmail", nullable: true, length: 255 })
  correspondenceEmail: string | null;

  @Column("varchar", { name: "promotionCode", nullable: true, length: 255 })
  ...
  @Column("varchar", {
    name: "referenceOverseasOffice",
    nullable: true,
    length: 5,
  })
  referenceOverseasOffice: string | null;
  ...
  @Column("varchar", { name: "formSubmissionKey", nullable: true, length: 100 })
  ...
  @OneToMany(
    ...
    (fairRegistrationProductStrategy) =>
      fairRegistrationProductStrategy.fairRegistration
  )
  ...
  @OneToMany(
    ...
    (fairRegistrationPreferredSuppCountryRegion) =>
      fairRegistrationPreferredSuppCountryRegion.fairRegistration
  )
  ...
  @OneToMany(
    ...
    (fairRegistrationProductInterest) =>
      fairRegistrationProductInterest.fairRegistration
  )
  fairRegistrationProductInterests: FairRegistrationProductInterest[];

  @OneToMany(
    () => FairRegistrationNob,
    (fairRegistrationNob) => fairRegistrationNob.fairRegistration
  )
  ...
  @OneToMany(
    ...
    (fairRegistrationTypesOfTargetSuppliers) =>
      fairRegistrationTypesOfTargetSuppliers.fairRegistration
  )
  ...
  @OneToMany(
    ...
    (fairRegistrationCustomQuestion) =>
    fairRegistrationCustomQuestion.fairRegistration
  )
  fairRegistrationCustomQuestions: FairRegistrationCustomQuestion[];

  @OneToMany(
    () => FairRegistrationTicketPass,
    (fairRegistrationTicketPass) =>
    fairRegistrationTicketPass.fairRegistration
  )
  fairRegistrationTicketPasses: FairRegistrationTicketPass[];

  @OneToMany(
    () => FairRegistrationDynamicBm,
    (fairRegistrationDynamicBm) =>
    fairRegistrationDynamicBm.fairRegistration
  )
  ...
  @OneToMany(
    ...
    (fairRegistrationDynamicOthers) =>
    fairRegistrationDynamicOthers.fairRegistration
  )
  fairRegistrationDynamicOthers: FairRegistrationDynamicOthers[];

  @ManyToOne(
    () => FairParticipant,
    (fairParticipant) => fairParticipant.fairRegistrations,
  ...
  @ManyToOne(
    ...
    (fairRegistrationType) => fairRegistrationType.fairRegistrations,
    { onDelete: "RESTRICT", onUpdate: "RESTRICT" }
  )
  ...
  @ManyToOne(
    ...
    (fairRegistrationStatus) => fairRegistrationStatus.fairRegistrations,
    { onDelete: "RESTRICT", onUpdate: "RESTRICT" }
  )
  @JoinColumn([
    { name: "fairRegistrationStatusId", referencedColumnName: "id" },
  ])
  fairRegistrationStatus: FairRegistrationStatus;

  @ManyToOne(
    () => FairParticipantType,
    (fairParticipantType) => fairParticipantType.fairRegistrations,
    { onDelete: "RESTRICT", onUpdate: "RESTRICT" }
  )
  ...
  @ManyToOne(
    ...
    (c2mParticipantStatus) => c2mParticipantStatus.fairRegistrations,
    { onDelete: "RESTRICT", onUpdate: "RESTRICT" }
  )
  ...
  @ManyToOne(
    () => FairFormTemplate,
    (fairFormTemplate) => fairFormTemplate.fairRegistrations,
    { onDelete: "RESTRICT", onUpdate: "RESTRICT" }
  )
  ...
  @JoinColumn([
    { name: "sourceTypeCode", referencedColumnName: "sourceTypeCode" },
  ])
  sourceTypeCode2: SourceType;

  @ManyToOne(
    () => VisitorType,
    (visitorType) => visitorType.fairRegistrations,
    { onDelete: "RESTRICT", onUpdate: "RESTRICT" }
  )
  @JoinColumn([
    { name: "visitorTypeCode", referencedColumnName: "visitorTypeCode" },
  ])
